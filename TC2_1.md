A partir de agora, você precisará provar 5 tipos de questões
...
Utilize estritamente o estilo de método de prova do teorema 3.14, com passo a passo da mesma forma. Ou seja, use e abuse do "se e somente se" e UTILIZE O TEOREMA DO PARÂMETRO. Faça do passo 1 o programa, e depois o passo 2 e 3 é o resto da prova.
...
Geralmente as questões irão envolver provar algo sobre um conjunto ser ou não ser recursivo ou recursivamente enumerável. Além disso, pode existir questões envolvendo operações com strings.
